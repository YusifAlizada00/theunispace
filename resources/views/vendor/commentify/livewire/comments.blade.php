<div>
    <section class="bg-white dark:text-gray-800 py-8 lg:py-16">
        <div class="max-w-2xl mx-auto px-4">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-lg lg:text-2xl font-bold text-gray-900">{{ __('commentify::commentify.comments.discussion') }}
                    ({{$comments->total()}})</h2>
            </div>
            @auth
