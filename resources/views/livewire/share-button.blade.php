<div>
    ...
    <!-- The share button -->
    <button wire:click="showOverlay" class="flex items-center gap-2 group/share transition-all">
        <div class="p-2 rounded-full text-slate-400 group-hover/share:bg-indigo-50 group-hover/share:text-indigo-600 transition-colors">
            {{-- Modern Share Icon --}}
            <svg class="w-6 h-6 transition-transform group-hover/share:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50"
                ...
                <div class="bg-gray-900 rounded-2xl p-6 w-full max-w-3xl text-gray-200 shadow-xl">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button wire:click="hideOverlay" class="ml-auto md:-ml-8 gap-2 text-slate-500 hover:text-blue-500 transition-colors group/share">
