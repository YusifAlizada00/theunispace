<div class="flex items-center">
    @if ($isLiked)
        <button wire:click="unlike" class="flex items-center gap-2 text-slate-500 hover:text-pink-500 transition-colors group">
            <svg class="w-6 h-6 transition-transform group-hover:scale-110 text-pink-500 fill-pink-500" viewBox="0 0 24 24">
        ...
        @else
            <span class="text-sm font-semibold ml-2">Like</span>
        @endif
    @else
        <button wire:click="like" class="flex items-center gap-2 text-slate-500 hover:text-pink-500 transition-colors group">
