        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-10">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    <a href="{{ route('study-groups') }}" class="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-indigo-600 transition-colors">
                    ...
                    @if($studyGroup->date->isFuture())
                        <span
                            class="inline-flex w-fit items-center px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    {{-- Main Content Card --}}
                    <div class="bg-white rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden p-8 md:p-10">
                        ...
                        <div class="flex flex-col gap-6 mb-10 pb-10 border-b border-gray-100">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm md:text-lg font-bold text-slate-800">{{ $studyGroup->date->format('D, M jS') }}
</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm md:text-lg font-bold text-slate-800">{{ $studyGroup->start_time->format('g:ia') }} - {{ $studyGroup->end_time->format('g:ia') }}</p>
                                </div>
                            </div>

                            {{-- Location --}}
                            <div class="flex items-center gap-4">
                                <div class="w-12 h-12 rounded-2xl bg-pink-50 flex items-center justify-center text-pink-600 shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm md:text-lg font-bold text-slate-800 break-words">{{ $studyGroup->location }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-10">
                            ...
                            <div class="prose prose-slate max-w-none text-slate-600 leading-relaxed bg-slate-50 rounded-2xl p-6 border border-slate-100">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="bg-gray-100 text-gray-600 py-1 px-3 rounded-full text-xs font-bold">{{ count($studyGroup->members) }} Active</span>
                            </div>
                ...
                <div class="space-y-6">
                    ...
                    {{-- Host Card --}}
                    <div class="bg-white rounded-[2rem] p-6 pt-12 shadow-xl shadow-gray-200/50 border border-gray-100 text-center relative overflow-hidden">
                        ...
                        <div class="relative -mt-8 mb-3">
                            <img src="https://ui-avatars.com/api/?name=Yusif+Alizada" class="w-20 h-20 rounded-full border-4 border-white shadow-md mx-auto">
                        </div>
                        ...
                        <p class="mb-6 text-sm md:text-md text-slate-600 break-words">{{ $studyGroup->leader->email }}</p>
                        <a href="{{ route('posts.all', ['name' => $studyGroup->leader->slug]) }}" class="w-full py-2.5 px-12 rounded-xl border border-gray-200 text-gray-700 font-bold text-sm hover:bg-gray-50 transition">
                            View Profile
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-[2rem] p-6 shadow-xl shadow-gray-200/50 border border-gray-100">
                        ...
                        <p class="text-xs text-slate-500 mb-4 leading-relaxed">
                            You are currently a member of this group. If you can no longer attend, please leave to free up a spot.
                        </p>
