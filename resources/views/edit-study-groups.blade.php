    ...
    <div class="min-h-screen bg-gray-50/50 py-12 px-4 md:pl-[100px] lg:pl-[300px]">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-10">
                ...
                <h1 class="text-4xl font-black text-slate-900 tracking-tight mb-2">Update Study Group</h1>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden relative">
                ...
                <form action="{{ route('study-groups.update', $studyGroup->slug) }}" method="POST" class="p-8 md:p-10 space-y-10">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="group_name" value="{{ old('group_name', $studyGroup->group_name) }}" placeholder="e.g. Calculus Finals Prep" required
                        ...
                        <div class="">
                            ...
                            <div>
                                ...
                                <input type="text" name="subject" value="{{ old('subject', $studyGroup->subject) }}" placeholder="e.g. Math 101" required
                                    class="w-full px-5 py-4 rounded-2xl bg-gray-50 border-transparent focus:bg-white transition-all font-semibold placeholder:text-gray-400 placeholder:font-normal">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="date" value="{{ old('date', optional($studyGroup->date)->format('Y-m-d')) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="location" value="{{ old('location', $studyGroup->location) }}" placeholder="e.g. Library Room 3B" required
                                    class="w-full px-5 py-4 rounded-2xl bg-gray-50 border-transparent focus:bg-white transition-all font-semibold placeholder:text-gray-400 placeholder:font-normal">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="time" name="start_time" value="{{ old('start_time', optional($studyGroup->start_time)->format('H:i')) }}" required
                            ...
                            <div>
                                ...
                                <input type="time" name="end_time" value="{{ old('end_time', optional($studyGroup->end_time)->format('H:i')) }}" required
                                    class="w-full px-5 py-4 rounded-2xl bg-gray-50 border-transparent focus:bg-white transition-all font-semibold text-slate-600 text-center">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" placeholder="What are the goals for this session?"
                            class="w-full p-5 rounded-2xl bg-gray-50 border-transparent focus:bg-white transition-all font-medium resize-none placeholder:text-gray-400 placeholder:font-normal">
                            {{ old('description', $studyGroup->description) }}
                        </textarea>
                    </div>
